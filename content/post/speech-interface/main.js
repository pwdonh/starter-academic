  ...
  function plot_wav(spec, p_langs, t, f){
    ...
    var ticks = [0,500,1000,2000,4000,8000]
    var ticktext = ['0','.5',' 1',' 2',' 4',' 8']
    var tickvals = []
    for (i=0; i<ticks.length; i++) {
      var distance = ticks[ticks.length-1]
  ...
  function processDataURL(base64) {
    ...
    $.ajax({
        ...
        success: function( data, textStatus, jQxhr ){
            plot_wav(data.spec, data.p_lang, data.t, data.f)
        },
